...
def upload2():
    ...
    if (request.method == "POST"):
        ...
        board2.append(request_data['val1'])
        board2.append(request_data['val2'])
        board2.append(request_data['val3'])
        board2.append(request_data['val4'])
        board2.append(request_data['val5'])
        board2.append(request_data['val6'])
        board2.append(request_data['val7'])
        board2.append(request_data['val8'])
        board2.append(request_data['val9'])
        board2.append(request_data['val10'])
        board2.append(request_data['val11'])
        board2.append(request_data['val12'])
        board2.append(request_data['val13'])
        board2.append(request_data['val14'])
        board2.append(request_data['val15'])
        board2.append(request_data['val16'])
        board2.append(request_data['val17'])
        board2.append(request_data['val18'])
        board2.append(request_data['val19'])
        board2.append(request_data['val20'])
        board2.append(request_data['val21'])
        board2.append(request_data['val22'])
        board2.append(request_data['val23'])
        board2.append(request_data['val24'])
        board2.append(request_data['val25'])
        board2.append(request_data['val26'])
        board2.append(request_data['val27'])
        board2.append(request_data['val28'])
        board2.append(request_data['val29'])
        board2.append(request_data['val30'])
        board2.append(request_data['val31'])
        board2.append(request_data['val32'])
        board2.append(request_data['val33'])
        board2.append(request_data['val34'])
        board2.append(request_data['val35'])
        board2.append(request_data['val36'])
        board2.append(request_data['val37'])
        board2.append(request_data['val38'])
        board2.append(request_data['val39'])
        board2.append(request_data['val40'])
        board2.append(request_data['val41'])
        board2.append(request_data['val42'])
        board2.append(request_data['val43'])
        board2.append(request_data['val44'])
        board2.append(request_data['val45'])
        board2.append(request_data['val46'])
        board2.append(request_data['val47'])
        board2.append(request_data['val48'])
        board2.append(request_data['val49'])
        board2.append(request_data['val50'])
        board2.append(request_data['val51'])
        board2.append(request_data['val52'])
        board2.append(request_data['val53'])
        board2.append(request_data['val54'])
        board2.append(request_data['val55'])
        board2.append(request_data['val56'])
        board2.append(request_data['val57'])
        board2.append(request_data['val58'])
        board2.append(request_data['val59'])
        board2.append(request_data['val60'])
        board2.append(request_data['val61'])
        board2.append(request_data['val62'])
        board2.append(request_data['val63'])
        board2.append(request_data['val64'])
        board2.append(request_data['val65'])
        board2.append(request_data['val66'])
        board2.append(request_data['val67'])
        board2.append(request_data['val68'])
        board2.append(request_data['val69'])
        board2.append(request_data['val70'])
        board2.append(request_data['val71'])
        board2.append(request_data['val72'])
        board2.append(request_data['val73'])
        board2.append(request_data['val74'])
        board2.append(request_data['val75'])
        board2.append(request_data['val76'])
        board2.append(request_data['val77'])
        board2.append(request_data['val78'])
        board2.append(request_data['val79'])
        board2.append(request_data['val80'])
        board2.append(request_data['val81'])
        board2 = app_running2(board2)
        return jsonify({"message": "List Uploaded Successfuly"})
    if (request.method == "GET"):
        return jsonify({'val':board2[0], 'val2':board2[1], 'val3':board2[2], 'val4':board2[3], 'val5':board2[4], 'val6':board2[5], 'val7':board2[6], 'val8':board2[7], 'val9':board2[8], 'val10':board2[9], 'val11':board2[10], 'val12':board2[11], 'val13':board2[12], 'val14':board2[13], 'val15':board2[14], 'val16':board2[15], 'val17':board2[16], 'val18':board2[17], 'val19':board2[18], 'val20':board2[19], 'val21':board2[20], 'val22':board2[21], 'val23':board2[22], 'val24':board2[23], 'val25':board2[24], 'val26':board2[25], 'val27':board2[26], 'val28':board2[27], 'val29':board2[28], 'val30':board2[29], 'val31':board2[30], 'val32':board2[31], 'val33':board2[32], 'val34':board2[33], 'val35':board2[34], 'val36':board2[35], 'val37':board2[36], 'val38':board2[37], 'val39':board2[38], 'val40':board2[39], 'val41':board2[40], 'val42':board2[41], 'val43':board2[42], 'val44':board2[43], 'val45':board2[44], 'val46':board2[45], 'val47':board2[46], 'val48':board2[47], 'val49':board2[48], 'val50':board2[49], 'val51':board2[50], 'val52':board2[51], 'val53':board2[52], 'val54':board2[53], 'val55':board2[54], 'val56':board2[55], 'val57':board2[56], 'val58':board2[57], 'val59':board2[58], 'val60':board2[59], 'val61':board2[60], 'val62':board2[61],'val63':board2[62], 'val64':board2[63], 'val65':board2[64], 'val66':board2[65], 'val67':board2[66], 'val68':board2[67], 'val69':board2[68], 'val70':board2[69],'val71':board2[70], 'val72':board2[71], 'val73':board2[72], 'val74':board2[73], 'val75':board2[74], 'val76':board2[75], 'val77':board2[76], 'val78':board2[77], 'val79':board2[78], 'val80':board2[79], 'val81':board2[80]})
